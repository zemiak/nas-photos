...
public class StreamingServlet extends HttpServlet {
    ...
    private Path getMoviePath(HttpServletRequest request) {
        String path;
        ...
        return Paths.get(photoPath, path);
    }
    ...
    private void processRequest
        ...
        Path requestedFilePath = getMoviePath(request);
        String requestedFile = requestedFilePath.toString();
